...
enclosed by '"'
lines terminated by '\n'
(urn, work, title_eng, orig_lang, notes, urn_status, created_by, edited_by);
...
enclosed by '"'
lines terminated by '\n'
(urn, textgroup, groupname_eng, has_mads, mads_possible, notes, urn_status, created_by, edited_by);
